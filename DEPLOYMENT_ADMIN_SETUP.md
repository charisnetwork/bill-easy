...
RAILWAY_SAAS_LINK=https://bill-easy-production-v4.up.railway.app
...
```env
VITE_BACKEND_URL=https://bill-easy-production-v4.up.railway.app
```
...
**Result**: `https://admin-bill-easy-production-v4.up.railway.app`
...
5. Add Environment Variables:
   ```
   VITE_ADMIN_API_URL=https://admin-bill-easy-production-v4.up.railway.app
   VITE_ADMIN_SECRET=your_super_secret_key_here
   ```
6. Deploy
